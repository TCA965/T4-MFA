...
void seite6()
{
  ...
  dogm.start();
  do {
    schreibeOben_Unten("NEW");

    //Gesamte Strecke
    dogm.setXY(4, 35);
    dogm.setFont(font_5x8);
    dogm.print(" ");
    dogm.print(FuenfKm[0], 1);
    dogm.print(" ");
    dogm.print(FuenfKm[1], 1);
    dogm.print(" ");
    dogm.print(FuenfKm[2], 1);
    dogm.print(" ");
    dogm.print(FuenfKm[3], 1);
    dogm.print(" ");
    dogm.print(FuenfKm[4], 1);
    dogm.print(" ");
